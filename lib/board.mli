...
val coordinates_from_directions :
  Type.direction_deplacement -> int * int -> int * int
...
val node_from_direction :
  Type.board ->
  Type.coordinates -> Type.direction_deplacement -> Type.coordinates option
val check_mill_from_position :
  Type.board -> Type.coordinates -> Type.color -> bool
val board_map :
  (Type.square -> Type.square) ->
  Type.board -> Type.coordinates -> Type.square list list
val place_piece_on_board :
  Type.board -> Type.coordinates -> Type.color -> Type.got_mill
val place_start_piece :
  Type.game_update -> Type.coordinates -> Type.color -> Type.game_update
val remove_from_board :
  Type.board -> Type.coordinates -> Type.color -> Type.board
val eliminate_piece :
  Type.game_update -> Type.coordinates -> Type.color -> Type.game_update
val move_to_coordinates :
  Type.game_update ->
  Type.coordinates -> Type.coordinates -> Type.color -> Type.game_update
val init_board : Type.square list list
val init_board_quarter : Type.board -> Type.board
val test_3_squares_row :
...
val move_to_direction :
  Type.game_update ->
  Type.coordinates ->
  Type.direction_deplacement -> Type.color -> Type.game_update
val possible_moves :
  Type.game_update ->
